export const claritySuccessStories = [
  {
    title: "Clarity PPM — Strategic Portfolio Management",
    paragraphs: [
      "Albatroz enabled the customer to successfully adopt Clarity's out-of-the-box Strategic Portfolio Management (SPM) capabilities with minimal customization. Initiative, service, and product data previously maintained in spreadsheets were migrated into Clarity using Custom Investment Types (CITs) and specialized data loaders.",
      "By implementing the Hierarchies and Roadmaps modules, Albatroz provided a centralized platform for strategic planning, portfolio visualization, and collaboration — helping the organization align initiatives with business objectives while improving planning efficiency and decision-making.",
    ],
  },
  {
    title: "Integration of Clarity with Third-Party Approval System",
    paragraphs: [
      "Albatroz enhanced the customer's project governance framework by seamlessly integrating Clarity with the SAP Approval Authority Engine (AAE), enabling a centralized and standardized approval process across the organization.",
      "The integration allowed Clarity to automatically trigger AAE approval workflows at predefined stages, display real-time approval status within Clarity, and capture approval decisions through a callback mechanism — streamlining approval management, eliminating duplicate processes, reducing licensing overhead, and ensuring smooth workflow progression.",
    ],
  },
  {
