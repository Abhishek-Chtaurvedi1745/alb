...
function PolicySection({ number, title, children }) {
  return (
    <div>
      <h2 className="mb-2 text-lg font-semibold leading-snug text-white sm:text-xl md:text-[25px]">
  ...
  return (
    <section className="mt-20 bg-black px-4 py-10 text-white sm:px-6 sm:py-12 md:px-12 md:py-16 lg:px-24">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mb-8 text-sm leading-relaxed text-white sm:text-base md:mb-10 md:text-[18px] md:leading-8">
        ...
        <div className="space-y-8 sm:space-y-10">
          <PolicySection number="1" title="Personal Information Collection:">
            <p className="text-sm font-light leading-relaxed text-white sm:text-base md:text-[18px] md:leading-8">
          ...
          <PolicySection number="2" title="Use of Personal Information:">
            <p className="mb-3 text-sm font-light leading-relaxed text-white sm:text-base md:text-[18px] md:leading-8">
          ...
          <PolicySection number="8" title="Contact Us:">
            <p className="mb-4 text-sm font-light leading-relaxed text-white sm:text-base md:text-[18px] md:leading-8">
              If you have any questions, concerns, or requests regarding this
              Privacy Policy or our privacy practices, please contact us at:
            </p>

            <div className="rounded-lg bg-zinc-900 p-4 sm:p-6">
              <p className="mb-2 break-all text-sm font-light text-white sm:text-base md:text-[18px]">
                <span className="font-semibold">Email:</span>{" "}
                info@albatrozsolutions.com
              </p>
              <p className="mb-2 text-sm font-light text-white sm:text-base md:text-[18px]">
