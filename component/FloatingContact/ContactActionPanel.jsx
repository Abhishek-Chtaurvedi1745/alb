...
import {
  ...
  PHONE_HREF,
  WHATSAPP_HREF,
} from "./contactActionConstants";

export default function ContactActionPanel({ onClose, onBookACall }) {
  return (
    <div className="float-contact-panel w-full overflow-hidden rounded-[22px] border border-white/10 bg-[#111111] shadow-[0_20px_50px_rgba(0,0,0,0.55)]">
      ...
      <div className="bg-[#151515]">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <p className="text-[15px] font-semibold text-white">Book a Call</p>
            <p className="text-[12px] text-white/55">
